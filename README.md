...
```sh
  mkdir folder_name
  cd folder_name
  git clone git@github.com:tsheporamantso/my-enumerable.git
```
...
Feel free to check the [issues page](https://github.com/tsheporamantso/my-enumerable/issues).
...
This project is [MIT](https://github.com/tsheporamantso/my-enumerable/blob/766ad6486d9e77824420fd304633381971f531e5/LICENSE) licensed.
